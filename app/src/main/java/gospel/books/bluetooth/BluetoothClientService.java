...
/**
 * @desc 蓝牙模块客户端主控制Service
 * Created by Gospel on 2017/9/4 14:47
 * DXC technology
 */
public class BluetoothClientService extends Service {
    String TAG = BluetoothClientService.class.getSimpleName();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BluetoothTools.MESSAGE_READ_OBJECT:
                    ...
                    CeLiangActivity.message = readMessage;
    ...
    public void onCreate() {
        ...
        Logger.i(TAG, "discoveryReceiver register success.");
        registerReceiver(controlReceiver, controlFilter);
        Logger.i(TAG, "controlReceiver register success.");
        super.onCreate();
    }

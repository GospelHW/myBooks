...
import gospel.books.dbhelp.SqliteUtils;
import gospel.books.logs.Logger;

/**
 * Created by gospel on 2017/8/18.
 * About Register
 */
public class BooksAcitvity extends AppCompatActivity {
    String TAG = BooksAcitvity.class.getSimpleName();
    Context context;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        booktime = (EditText) findViewById(R.id.booktime);
       ...
       /* sex = (RadioGroup) this.findViewById(R.id.radiogroup1);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Logger.i(TAG, bookname.getText().toString() + " ****");
                if (bookname.getText().toString()!=null && booktime.getText().toString()!=null) {
                    int isTure = SqliteUtils.getInstance(context).saveBooks(bookname.getText().toString(), booktime.getText().toString());
                    if (isTure == 1) {
                        try {
                            Thread.sleep(500);
                        ...
                        new AlertDialog.Builder(context)
                                ...
                                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Logger.i(TAG, bookname.getText().toString() + " books save success.");
                                        startActivity(new Intent(BooksAcitvity.this, MyMeasureList.class));
                                        finish();
                                    }
                                })
                                .show();
                    } else if (isTure == -1) {
                        Toast.makeText(BooksAcitvity.this, "book name exist...", Toast.LENGTH_SHORT).show();
                        Logger.i(TAG, bookname.getText().toString() + " book name exist. book save failed.");
                    } else {
                        Toast.makeText(BooksAcitvity.this, "book save failed", Toast.LENGTH_SHORT).show();
                        Logger.i(TAG, bookname.getText().toString() + "book save failed.");
                    }
                }else{
                    Toast.makeText(BooksAcitvity.this, "book name and book time are both not null", Toast.LENGTH_SHORT).show();
                    Logger.i(TAG, bookname.getText().toString() + "book name not null");
                }
            }
        });
        ...
        ((TextView) findViewById(R.id.title_name)).setText("Add Books");
